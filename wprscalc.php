...
echo "participant quality: $pq of 1.0" . PHP_EOL;
...
echo "participant number: $pn of 1.2" . PHP_EOL;
...
echo "task quality: $ta of 1.0 ($number_of_tasks of 3 tasks)" . PHP_EOL;
